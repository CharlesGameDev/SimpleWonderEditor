...
namespace ImGuiGeneral
{
	...
	{
		public static (IntPtr, IntPtr) CreateWindowAndGLContext(string title, int width, int height, bool fullscreen = false, bool highDpi = false, bool maximized = false)
		{
			...
			if (maximized) flags |= SDL_WindowFlags.SDL_WINDOW_MAXIMIZED;
